...
Note that we only use the lower part of the SD25 saildrive assembly. The top part has the gearbox (Forward/Reverse) for diesel engines - which is not needed.

<img src="./SD25_lower_unit.png" style="width: 50%; height: 50%">
